...
\begin{frame}{Summary}
  \begin{itemize}
  \item Two axes of similarity: structure and prize function.
...
\begin{frame}{The Median Tree Problem}{Motivation}
  \textit{I wanted to do some practical work.} \pause
  \begin{block}{Options}
  \begin{itemize}[<+->]
...
\begin{frame}{Reflections}{Futher Work}
  haha
\end{frame}
