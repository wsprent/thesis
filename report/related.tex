...
\todo[inline]{Be clear about the intuitive differences between the PCSTP and these problems}
...
the PCTSP -- involves dropping the quota constraint from the PCTSP, making it a true
 ...
 Specifically, the PTP involves finding a simple cycle,
 ...
 \begin{formulation}
   \begin{subequations}
     \begin{alignat}{3} %TODO: Find reference for this formulation
       ...
       & & \sum_{ij \in E} c_{ij} x_{ij} + \sum_{i \in V} p_iy_i  & \\
       & \text{subject to}\quad
