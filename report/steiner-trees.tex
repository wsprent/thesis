...
Figure (\ref{fig:pcstp:01}) shows an instance, $G$, of the \gls{pcstp} created by assigning prizes to the terminals of the \gls{stp} instance, $G_{\gls{stp}}$, in Figure (\ref{fig:stp:01}).
