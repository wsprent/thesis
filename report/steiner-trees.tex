...
This part of the thesis will make heavy references to the family of problems related to the
...
The \gls{sap} is relevant to our theis mainly due to a tendency of reformulating the
...
How to do this, is explored more deeply in Section~\ref{sec:solving:exact}.
...
alters the objective function to instead optimising the profit
