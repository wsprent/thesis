...
First we will give an overview of the dataset followed by an inspection of the three experiments we have
 ...
 enough to solve to optimality within a reasonable timeframe.
...
\end{verbatim}
 ...
 \lstinputlisting[caption={Figure \ref{fig:mtp:01} in the extended \texttt{STP} format.}]{data/report.stp}
 ...
 \textit{We use STP}
\textit{The extension. We have implemented a reader.}
\textit{How do we generate the datasets?}
