...
as the ILP in Fomulation (\ref{form:exact:cut}). 
 \begin{formulation}[h!]
   ...
   \end{subequations}
   \caption{(CUT-IP) CUT-based formulation of the constrained PCSAP.}
 \end{formulation}
...
\begin{figure}[t]
 ...
 PCSTP instance.
  ...
  Futhermore, SCIP-Jack contains an array of heuristics for the SAP which are not well described
