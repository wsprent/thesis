...
then Formulation (\ref{form:lower:gsec}) is a ILP formulation of the \gls{pcstp}. Constraints (\ref{form:lower:gsec:gsec}) are
referred to as generalised subtour elimination constraints, and together with constraint (\ref{form:lower:gsec:sum})
 ...
 \begin{formulation}[h!]
   ...
   \end{subequations}
   \caption{(GSEC-IP) GSEC formulation of the \gls{pcstp}.}
 \end{formulation}
